...
export const COMANDOS: readonly DefinicionComando[] = [
  ...
  {
    nombre: 'unirme',
    descripcion: '🔑 Sumarte a otro equipo con un código',
    rolMinimo: 'cualquiera',
  },
  ...
  { nombre: 'reabrir', descripcion: '↩️ Reabrir un partido cerrado', rolMinimo: 'admin' },
  {
    nombre: 'deshacer',
    descripcion: '↩️ Borrar el último evento que cargaste',
    rolMinimo: 'editor',
  },
